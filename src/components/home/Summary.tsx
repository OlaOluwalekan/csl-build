...
const Summary = ({
  ...
  return (
    <div className="bg-navy-blue text-base-white w-[calc(50vw-30px)] relative rounded-xl overflow-hidden tablet:w-[calc(50vw-60px)] laptop:w-[100%] desktop:w-[200px] large:w-[calc(25%-12px)] large:aspect-[4/2] large:min-h-[150px] small:w-full">
